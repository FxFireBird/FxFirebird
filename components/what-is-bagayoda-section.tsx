      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base text-muted-foreground max-w-xl mx-auto">
            Professional adaptive trading infrastructure.
          </p>
        </motion.div>
          ...
          >
            <div className="space-y-4">
              <p className="text-lg text-foreground font-medium">
                Bagayoda is not a traditional EA.
              </p>

              <p className="text-muted-foreground leading-relaxed">
                Bagayoda is a cloud-controlled execution framework that connects licensed trading accounts to the FxFirebird infrastructure.
              </p>

              <p className="text-muted-foreground leading-relaxed">
                The system does not trade independently. Every action requires authorization from the licensing server.
              </p>
            </div>
